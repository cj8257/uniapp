...
function initRuntimeSocketService() {
  const hosts = "192.168.123.12,192.168.136.1,192.168.10.1,192.168.253.1,127.0.0.1,172.26.160.1";
  const port = "8090";
  const id = "mp-weixin_Mkn7Rl";
...
const pages = [
  ...
  {
    path: "pages/device/upload",
    style: {
      navigationBarTitleText: "设备信息上传"
    }
  },
  {
    path: "pages/device/overview",
    style: {
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.123.12","192.168.136.1","192.168.10.1","192.168.253.1","172.26.160.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/admin/Downloads/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"cloud1","spaceId":"mp-937c9de2-6caa-4033-a60d-7ccca5cfc715","clientSecret":"J8mdI9jCRG9jiTiQsaFkaw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__5A754C7";
} catch (e2) {
