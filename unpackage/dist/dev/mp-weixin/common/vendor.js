...
function initRuntimeSocketService() {
  const hosts = "192.168.123.12,192.168.136.1,192.168.10.1,192.168.253.1,127.0.0.1,172.25.176.1";
  const port = "8090";
  const id = "mp-weixin_Vr12jW";
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.123.12","192.168.136.1","192.168.10.1","192.168.253.1","172.25.176.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/admin/Downloads/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"device","spaceId":"mp-d58e61df-327e-4da4-8ba3-d2e0216c10ce","clientSecret":"FHS/K6wamcpqpQ9dpEusvw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__5A754C7";
} catch (e2) {
